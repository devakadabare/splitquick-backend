 ...
 */
export function simplifySettlements(balances: Balance[]): Transaction[] {
 ...
 */
export function calculateNetBalances(balances: Balance[]): Balance[] {
  return balances
 ...
 */
export function validateSettlements(originalBalances: Balance[], transactions: Transaction[]): boolean {
  const balanceCheck: { [userId: string]: number } = {};
 ...
 */
export function formatSettlements(transactions: Transaction[]): string[] {
